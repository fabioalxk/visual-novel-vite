const scenes = [
  {
    ...
    dialogues: [
      { character: "Ted", text: "Oi, Luna! Que bom que você conseguiu vir." },
      {
        character: "Luna",
        text: "Oi, Ted! Obrigada pelo convite. Sua casa é muito aconchegante.",
      },
      {
        character: "Ted",
        text: "Fico feliz que você gostou. Que tal começarmos na cozinha com algo para beber?",
      },
    ],
    options: [
      { text: "Oferecer uma bebida", nextScene: 2, effect: { interest: +5 } },
    ],
